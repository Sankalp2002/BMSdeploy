...
urlpatterns=[
    ...
    path('Donors/delete/<str:did>',views.deldonview,name='deldonview'),
    ...
    path('Patient/edit/<str:pid>',views.editpatview,name='editpatview'),
    path('Patient/save/<str:pid>',views.editpatsave,name='editpatsave'),
